...
const Redeem = () => {
    ...
    const products = [
        {
            id: 1,
            name: "Protein Powder",
            description: "Premium whey protein supplement with 25g of protein per serving. Perfect for post-workout recovery and muscle building. Contains all essential amino acids.",
            points: 200,
        ...
        },
        {
            id: 2,
            name: "Gym Towel",
            description: "Premium microfiber gym towel that's super absorbent and quick-drying. Perfect size for gym sessions and workouts.",
            points: 100,
        ...
        },
        {
            id: 3,
            name: "Water Bottle",
            description: "Insulated sports water bottle that keeps drinks cold for 24 hours. BPA-free and perfect for intense workout sessions.",
            points: 150,
    ...
    const handleRedeemPress = (product: any) => {
                ...
                <View className="pt-4">
                    ...
                    <View className="p-6 mb-12 mt-8 flex justify-center items-center">
                        <View className="mb-4">
                            ...
                            />
                            <View className='mt-3'>
                                <Text className="text-white/60 text-lg mb-3 text-center">Your Points</Text>
                                <Text className="text-amber-400 text-6xl font-light text-center">500</Text>
                            </View>
                        </View>
                    ...
                    <View className="mb-6">
                        <View className="flex flex-row items-center justify-between mb-2">
                            <Text className="text-white text-xl font-bold mb-4">Featured Rewards</Text>
                            <CircleChevronRight
                        ...
                        >
                            ...
                            <View className="flex-1">
                                <Text className="text-white font-bold text-lg mb-1">{products[0].name}</Text>
                                <Text className="text-white/60 text-sm mb-2">{products[0].description.substring(0, 40)}...</Text>
                                <View className="flex-row items-center justify-between">
                                    <View className="flex-row items-center">
                                        <Image
                                            ...
                                            source={require('../assets/images/star.png')}
                                        />
                                        <Text className="text-amber-400 font-bold">{products[0].points} pts</Text>
                                    </View>
                                    <TouchableOpacity
                        ...
                        >
                            ...
                            />
                            <View className="flex-1">
                                <Text className="text-white font-bold text-lg mb-1">{products[1].name}</Text>
                                <Text className="text-white/60 text-sm mb-2">{products[1].description.substring(0, 40)}...</Text>
                                <View className="flex-row items-center justify-between">
                                    <View className="flex-row items-center">
                                        <Image
                                            className="h-4 w-4 mr-1"
                                            source={require('../assets/images/star.png')}
                                        />
                                        <Text className="text-amber-400 font-bold">{products[1].points} pts</Text>
                                    </View>
                                    <TouchableOpacity
                                        className="bg-amber-500 px-4 py-2 rounded-full"
                                        onPress={() => handleRedeemPress(products[1])}
                        ...
                        >
                            ...
                            />
                            <View className="flex-1">
                                <Text className="text-white font-bold text-lg mb-1">{products[2].name}</Text>
                                <Text className="text-white/60 text-sm mb-2">{products[2].description.substring(0, 40)}...</Text>
                                <View className="flex-row items-center justify-between">
                                    <View className="flex-row items-center">
                                        <Image
                                            className="h-4 w-4 mr-1"
                                            source={require('../assets/images/star.png')}
                                        />
                                        <Text className="text-amber-400 font-bold">{products[2].points} pts</Text>
                                    </View>
                                    <TouchableOpacity
                                        className="bg-amber-500 px-4 py-2 rounded-full"
                                        onPress={() => handleRedeemPress(products[2])}
                    ...
                    <View className="mb-6">
                        ...
                        <View className="flex-row justify-between mb-4">
                            <TouchableOpacity className="bg-secbg rounded-2xl p-4 flex-1 mr-2 items-center">
                                ...
                                <Text className="text-white text-sm font-medium">Equipment</Text>
                            </TouchableOpacity>
                            <TouchableOpacity className="bg-secbg rounded-2xl p-4 flex-1 mx-1 items-center">
                                ...
                                <Text className="text-white text-sm font-medium">Supplements</Text>
                            </TouchableOpacity>
                    ...
                    <View className="mb-6">
                        ...
                        <View className="bg-secbg rounded-2xl p-4 mb-3">
                            <View className="flex-row justify-between items-center">
                                <View>
                                    <Text className="text-white font-semibold">Workout Completed</Text>
                                    <Text className="text-white/60 text-sm">Upper Body Push Day</Text>
                                </View>
                        ...
                        <View className="bg-secbg rounded-2xl p-4 mb-3">
                            <View className="flex-row justify-between items-center">
                                <View>
                                    <Text className="text-white font-semibold">Challenge Won</Text>
                                    <Text className="text-white/60 text-sm">7-Day Attendance</Text>
                                </View>
                        ...
                        <View className="bg-secbg rounded-2xl p-4">
                            <View className="flex-row justify-between items-center">
                                <View>
                                    ...
                                    <Text className="text-white/60 text-sm">5 days this week</Text>
                                </View>
                    ...
                    <View className="bg-secbg rounded-3xl p-6 mx-4 w-11/12 max-h-5/6">
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <View className="items-center mb-6 mt-8">
                                ...
                                <Text className="text-white text-2xl font-bold mb-2">Redemption Successful!</Text>
                                <Text className="text-white/60 text-center">Your reward has been redeemed successfully</Text>
                            </View>
                            ...
                            {selectedProduct && (
                                <>
                                    ...
                                    <View className="bg-gray-800 rounded-2xl p-4 mb-6">
                                        <Text className="text-white font-bold text-lg mb-3 text-center">Sponsored by</Text>
                                    ...
                                    <View className="bg-blue-600 rounded-2xl p-4 mb-6">
                                        <Text className="text-white font-bold text-base mb-2">How to Redeem:</Text>
