...
const posts: Post[] = [
    { id: 1, media: require('../../assets/images/soc5.jpg'), mediaType: 'image', user: 'Nihas', time: '3 sec ago' },
    { id: 2, media: require('../../assets/images/soc2.jpg'), mediaType: 'image', user: 'Sharath', time: '1 min ago' },
    { id: 3, media: require('../../assets/images/soc3.jpg'), mediaType: 'image', user: 'Appu', time: '5 min ago' },
    { id: 4, media: require('../../assets/videos/sample.mp4'), mediaType: 'video', user: 'Amal', time: '1 hr ago' },
    { id: 5, media: require('../../assets/images/soc6.jpg'), mediaType: 'image', user: 'Pattu', time: '10 min ago' },
    { id: 6, media: require('../../assets/images/soc2.jpg'), mediaType: 'image', user: 'Rahul', time: '20 min ago' },
    { id: 7, media: require('../../assets/images/soc3.jpg'), mediaType: 'image', user: 'Amal', time: '1 hr ago' },
    { id: 8, media: require('../../assets/videos/sample2.mp4'), mediaType: 'video', user: 'Amal', time: '1 hr ago' },
    { id: 9, media: require('../../assets/images/soc4.jpg'), mediaType: 'image', user: 'Amal', time: '1 hr ago' },
...
const Social = () => {
    ...
    useEffect(() => {
        if (selectedImage && selectedImage.mediaType === 'video' && videoRef.current) {
                ...
                {post.mediaType === 'image' ? (
                    ...
                    <View style={{
                        ...
                        aspectRatio: videoDimensions?.[post.id] 
                            ? videoDimensions[post.id].width / videoDimensions[post.id].height
                            : 16/9,
                        borderRadius: 16,
                        backgroundColor: '#000',
                        overflow: 'hidden'
    ...
    const renderThumbnail = ({ item }: { item: Post }) => (
        <TouchableOpacity
            ...
            className={`mx-1 mb-2 ${selectedImage?.id === item.id ? 'opacity-50' : ''}`}
        >
            <Image
                source={item.media}
                style={{
            ...
            <View className="flex-1 bg-black pt-10">
                ...
                >
                    ...
                    <View className="flex-row items-center justify-between px-4 pb-4">
                        ...
                        <Text className="text-white text-lg font-semibold">{selectedImage.user}'s Post</Text>
                        <View style={{ width: 40 }} />
                    </View>
                    ...
                    <View className="px-2">
                        ...
                        >
                                ...
                                <Image
                                    ...
                                    style={{
                                        width: screenWidth - 16, // Full width minus padding
                                        height: undefined,
                                        aspectRatio: Image.resolveAssetSource(selectedImage.media).width / Image.resolveAssetSource(selectedImage.media).height,
                                        borderRadius: 24,
                                    }}
                                    resizeMode="contain"
                                />
                                ...
                                <View style={{
                                    ...
                                    aspectRatio: videoDimensions[selectedImage.id]
                                        ? videoDimensions[selectedImage.id].width / videoDimensions[selectedImage.id].height
                                        : 16/9,
                                    borderRadius: 24,
                                    overflow: 'hidden',
                                    backgroundColor: '#000',
                                    ...
                                    <Video
                                        ...
                                        onLoadStart={() => {
                                            console.log('Video loading started for', selectedImage.id);
                                        }}
                                    />
                                    {!showVideoControls && (
                                        <TouchableOpacity
                                            ...
                                            onPress={() => {
                                                ...
                                                // Enable audio when showing controls
                                                if (videoRef.current) {
                                                ...
                                                videoControlsTimeoutRef.current = setTimeout(() => {
                                                    setShowVideoControls(false);
                                                    // Mute video when hiding controls
                                                    if (videoRef.current) {
                    ...
                    <View className="flex-row items-center px-4 py-4">
                        ...
                        />
                        <View className="ml-3">
                            <Text className="text-white text-base font-semibold">{selectedImage.user}</Text>
                            <Text className="text-white/50 text-sm">{selectedImage.time}</Text>
                        </View>
                    </View>

                    {/* More to explore */}
                    <View className="px-2 mt-4">
                        <Text className="text-white text-base font-semibold px-2 mb-3">More to explore</Text>
                        <View className="flex-row justify-between">
                            <View className="w-[49%]">
                                {posts.filter((post) => post.id % 2 === 0 && post.id !== selectedImage.id).map((post) => (
                                    <TouchableOpacity
                                        key={post.id}
                                        onPress={() => {
                                            setSelectedImage(post);
