        ...
        <View className="flex bg-secbg rounded-2xl p-4">
          <View className="flex flex-row items-center justify-between mb-4">
            <View className="flex flex-row items-center">
              <Text className="text-white text-xl font-bold me-4">
                Last Workout
              </Text>
              ...
              return (
                <View
                  ...
                  className={`flex flex-row ${
                    isLastWeek ? "justify-start" : "justify-between"
                  } mb-2`}
                >
                  {Array.from({ length: end - start + 1 }).map(
                    (_, dayIndex) => {
                      ...
                      const isGreen = [
                        1, 2, 4, 5, 6, 8, 10, 11, 13, 15, 17, 18, 20, 21, 23,
                        24, 25, 27, 28, 29,
                      ].includes(date);
                      return (
                        <View
                          key={date}
                          className="flex justify-center items-center w-[13%]"
                        >
                          <TouchableOpacity
                            className={`${
                              isGreen ? "bg-green-600" : "bg-input"
                            } rounded-full w-12 h-12 border border-white/10 items-center justify-center`}
                          >
